import {getCurrencyFormattedNumber, isInt, scrubFormatting, getFormattedNumber, paddedFormatting} from './numberFormat';
...
describe('Number Formatter', () => {
  ...
  describe('paddedFormatting', () => {
    it('returns a string with a specified length of 3', () => {
      expect(paddedFormatting(1, 4)).toEqual('0001');
    });
  });
});
